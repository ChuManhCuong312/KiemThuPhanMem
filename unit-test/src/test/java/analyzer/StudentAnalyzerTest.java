...
// ===== TEST countExcellentStudents =====
    ...
    @Test // Black-box: RP | White-box: CFG (nhánh valid + invalid)
    ...
    @Test // Black-box: RP | White-box: CFG (scores.isEmpty)
    public void testCountExcellentStudents_EmptyList() {
        StudentAnalyzer analyzer = new StudentAnalyzer();
        assertEquals(0, analyzer.countExcellentStudents(Collections.emptyList()));
    }

    @Test // Black-box: RP | White-box: CFG (score == null)
    ...
    @Test // Black-box: BVA | White-box: CFG (score >= 8.0)
    ...
    @Test // Black-box: BVA | White-box: CFG (score > 10)
    ...
    @Test // Black-box: RP | White-box: CFG (scores == null)
...
// ======= BỔ SUNG LOGIC =======
    ...
    @Test // Black-box: DT | White-box: DFG (count++)
    ...
    @Test // Black-box: DT | White-box: CFG (no score >=8)
...
// ===== TEST calculateValidAverage =====
    ...
    @Test // Black-box: RP | White-box: DFG (sum, validCount)
    ...
    @Test // Black-box: RP | White-box: CFG (validCount == 0)
    ...
    @Test // Black-box: BVA | White-box: CFG (0 and 10)
...
// ======= BỔ SUNG LOGIC =======
    ...
    @Test // Black-box: DT | White-box: DFG (all valid path)
    ...
    @Test // Black-box: BVA | White-box: DFG (fractional)
